    ...
    <div class="max-w-lg">
        <div class="card">
            <div class="px-6 py-5 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-500 mt-0.5">Update the supplier information below.</p>
            </div>
            <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="p-6">
                ...
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name', $supplier->name) }}" required autofocus
